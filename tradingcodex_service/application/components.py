...
HARNESS_COMPONENTS: tuple[HarnessComponent, ...] = (
    ...
    HarnessComponent(
        ...
        summary="Routes reusable Datasets, enabled user capabilities, the optional managed OpenBB transport, and TradingCodex official/web fallback while preserving source quality and provenance.",
        status="core",
        tags=("guardrail.guidance", "improvement.workflow_quality"),
        surfaces={
            "services": (
            ...
            "skills": ("tcx-source-gate", "tcx-openbb"),
            "instructions": ("AGENTS",),
            ...
            "hooks": ("tradingcodex_hook",),
            "tests": ("external-data",),
        },
        depends_on=("workflow-quality-gates",),
        owned_capabilities=(
            "evidence.external_source_gate",
            "evidence.openbb_read_only_transport",
            "evidence.official_source_fallback",
        ),
        validation=("pytest", "routing scenario tests"),
    ),
    HarnessComponent(
