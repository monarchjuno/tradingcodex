...
| [generated-workspaces.md](./generated-workspaces.md) | `tcx init`, generated files, project-scoped MCP config, smoke checks, workspace provenance | Workspace templates, bootstrap behavior, generated files, hooks, MCP config, or `./tcx` wrapper behavior changes |
